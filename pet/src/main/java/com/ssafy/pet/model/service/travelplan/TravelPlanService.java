...
public interface TravelPlanService {
	...
	List<Integer> getUserFavoritePlanIds(String userId, int lowerBound, int upperBound);
	...
	// 정렬 타입별 게시글 조회
	List<TravelPlansDto> getPlansBySort(String sort, int page_start, int page_size, int user_id);
