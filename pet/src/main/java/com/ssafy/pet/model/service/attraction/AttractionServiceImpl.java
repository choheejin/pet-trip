...
public class AttractionServiceImpl implements AttractionService {
	...
	@Override
	public int addHotplace(int content_id, String userId) {
	...
	public int deleteHotplace(int content_id, String userId) {
		int user_id = userMapper.findIdByUserId(userId);
	...
	@Override
	public List<Integer> listHotplaceContentIdsByUserId(String userId) {
		int user_id = userMapper.findIdByUserId(userId);
